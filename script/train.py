...
from CDPT.data.dataset import WaymaxDataset
...
def train(cfg):
    ...
    if use_wandb:
        ...
        logger = CSVLogger(output_path, name="CDPT", version=1, flush_logs_every_n_steps=100)
...
def build_parser():
    ...
    parser.add_argument("-cfg", "--cfg", type=str, default="config/CDPT.yaml")
